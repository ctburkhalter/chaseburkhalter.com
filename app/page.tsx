              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    4+ years of experience in product analytics, event tracking, and data governance. Specializing in
                    driving strategic decision-making through robust analytics infrastructure and insights.
                  </p>
                </div>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
              <ProjectCard
                ...
                description="Led the migration of AJC's data warehouse from Redshift to Snowflake, improving performance and reducing costs while maintaining data integrity."
                tags={["Snowflake", "Redshift", "dbt", "SQL", "Data Migration"]}
                image="/placeholder.svg?height=200&width=300"
              />
              <ProjectCard
                title="Amplitude Implementation at AJC"
                description="Implemented Amplitude to replace Google Analytics, enabling stakeholder self-service analytics and improving product insights for digital properties."
                tags={["Amplitude", "Event Tracking", "Product Analytics", "Migration"]}
                image="/placeholder.svg?height=200&width=300"
              />
              <ProjectCard
                title="$100K Cost Savings with Superset"
                description="Orchestrated transition from proprietary visualization tools to Apache Superset at Shortcut, resulting in $100K+ annual savings."
                tags={["Apache Superset", "Cost Optimization", "Data Visualization", "Migration"]}
                image="/placeholder.svg?height=200&width=300"
              />
              <ProjectCard
                title="$1.4M Fraud Detection Analysis"
                description="Analyzed 3+ billion financial transactions to rebuild data aggregator management, resulting in $1.4M annualized savings while minimizing data loss."
                tags={["Python", "SQL", "Fraud Detection", "Big Data", "Financial Analytics"]}
                image="/placeholder.svg?height=200&width=300"
              />
              <ProjectCard
                title="Cross-Functional Analytics Platform"
                description="Built comprehensive analytics infrastructure supporting sales, finance, marketing, product, and engineering teams with unified reporting."
                tags={["Segment", "dbt", "Snowflake", "Multi-team Support"]}
                image="/placeholder.svg?height=200&width=300"
              />
              <ProjectCard
                title="Event Tracking Standardization"
                description="Designed and implemented standardized event tracking processes across web applications, enhancing self-serve analysis capabilities."
                tags={["Event Tracking", "Data Governance", "Segment", "Documentation"]}
                image="/placeholder.svg?height=200&width=300"
              />
            </div>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto max-w-4xl py-12">
              <div className="space-y-8">
                <div>
                  <h3 className="text-xl font-bold mb-4">Programming & Analytics Engineering</h3>
                ...
                <div>
                  <h3 className="text-xl font-bold mb-4">Data Visualization & Analytics</h3>
                  <div className="flex flex-wrap gap-2">
                    ...
                    <SkillBadge name="Hashboard" level={80} />
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <SkillBadge name="BigQuery" level={85} />
                    <SkillBadge name="Fivetran" level={90} />
                    <SkillBadge name="Hightouch" level={85} />
                    <SkillBadge name="Google Cloud" level={80} />
                    <SkillBadge name="Datafold" level={80} />
                    <SkillBadge name="Avo" level={85} />
                  </div>
                </div>
                <div>
                  <h3 className="text-xl font-bold mb-4">Analytics Methodologies</h3>
                  <div className="flex flex-wrap gap-2">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-4">Business Tools & Platforms</h3>
                  <div className="flex flex-wrap gap-2">
                    <SkillBadge name="Salesforce" level={80} />
                    <SkillBadge name="HubSpot" level={85} />
                    <SkillBadge name="Braze" level={80} />
                    <SkillBadge name="FullStory" level={85} />
                    <SkillBadge name="Stripe" level={75} />
                    <SkillBadge name="LaunchDarkly" level={80} />
                    <SkillBadge name="Optimizely" level={80} />
                    <SkillBadge name="Pendo" level={75} />
                  </div>
                </div>
              </div>
            </div>
